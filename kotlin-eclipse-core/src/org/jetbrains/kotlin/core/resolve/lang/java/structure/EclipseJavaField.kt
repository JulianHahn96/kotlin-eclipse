...
class EclipseJavaField(private val javaField: IVariableBinding) : EclipseJavaMember<IVariableBinding>(javaField), JavaField {
    ...
    override val type: JavaType
        get() = EclipseJavaType.create(binding.type)
