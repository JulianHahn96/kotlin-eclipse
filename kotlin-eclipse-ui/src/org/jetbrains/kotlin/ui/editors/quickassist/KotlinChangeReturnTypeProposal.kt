...
class KotlinChangeReturnTypeProposal(editor: KotlinEditor) : KotlinQuickAssistProposal(editor) {
    ...
    override fun isApplicable(psiElement: PsiElement): Boolean {
        ...
        val expression =
            PsiTreeUtil.getNonStrictParentOfType(activeDiagnostic.psiElement, KtExpression::class.java) ?: return false
        ...
        return when {
            canFunctionOrGetterReturnExpression(ktFunction, expression) -> {
